...
import "../structs/CircleManagerStructs.sol";

contract CircleManager is Ownable, ReentrancyGuard, CCIPReceiver {
    ...
    // CCIP receive function (FIXED: completed rebalance logic)
        ...
        if (message.data.length > 0) {
            ...
            if (messageType == keccak256("rebalance")) {
                ...
                if (message.data.length >= 32 + 20 + 32 + 32 + 32 + 8) {
                    ...
                    // Execute rebalance on this chain
