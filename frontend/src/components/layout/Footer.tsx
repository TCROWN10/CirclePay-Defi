...
const FOOTER_LINKS = {
  product: [
    ...
    { label: "Cross-Chain", href: "/dashboard/crosschain" },
    { label: "Yield Farming", href: "/dashboard/yield" },
  ],
  developers: [
    { label: "Documentation", href: "/docs" },
    { label: "API Reference", href: "/api" },
    { label: "Smart Contracts", href: "/SmartContract" },
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              <Image 
                ...
                priority
              />
              <span className="text-[#0C1523] font-bold text-xl">CirclePay</span>
            </div>
